...
Namespace HRISLibrary
    Public Module Declares
        ...
        Public CnString As String = "Server=localhost;Database=paymodule_dev;uid=root;pwd=;", _
               CmdParameterList As ArrayList = Nothing, _
               CmdString As String = "", _
